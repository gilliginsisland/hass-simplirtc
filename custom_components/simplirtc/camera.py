...
async def async_setup_platform(
    ...
    entry_id = discovery_info[CONF_ENTITY_ID]
    entry = hass.config_entries.async_get_known_entry(entry_id)

    return await async_setup_entry(hass, entry, add_entities)
...
async def async_setup_entry(
    ...
    simplisafe = hass.data[ENTRY_KEY][entry.entry_id]
