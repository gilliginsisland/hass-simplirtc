...
class SimulcastCodec(_message.Message):
    ...
    video_layer_mode: _livekit_models_pb2.VideoLayer.Mode
    def __init__(self, codec: _Optional[str] = ..., cid: _Optional[str] = ..., layers: _Optional[_Iterable[_Union[_livekit_models_pb2.VideoLayer, _Mapping]]] = ..., video_layer_mode: _Optional[_Union[_livekit_models_pb2.VideoLayer.Mode, str]] = ...) -> None: ...
...
class AddTrackRequest(_message.Message):
    ...
    stream: str
    backup_codec_policy: _livekit_models_pb2.BackupCodecPolicy
    audio_features: _containers.RepeatedScalarFieldContainer[_livekit_models_pb2.AudioTrackFeature]
    def __init__(self, cid: _Optional[str] = ..., name: _Optional[str] = ..., type: _Optional[_Union[_livekit_models_pb2.TrackType, str]] = ..., width: _Optional[int] = ..., height: _Optional[int] = ..., muted: _Optional[bool] = ..., disable_dtx: _Optional[bool] = ..., source: _Optional[_Union[_livekit_models_pb2.TrackSource, str]] = ..., layers: _Optional[_Iterable[_Union[_livekit_models_pb2.VideoLayer, _Mapping]]] = ..., simulcast_codecs: _Optional[_Iterable[_Union[SimulcastCodec, _Mapping]]] = ..., sid: _Optional[str] = ..., stereo: _Optional[bool] = ..., disable_red: _Optional[bool] = ..., encryption: _Optional[_Union[_livekit_models_pb2.Encryption.Type, str]] = ..., stream: _Optional[str] = ..., backup_codec_policy: _Optional[_Union[_livekit_models_pb2.BackupCodecPolicy, str]] = ..., audio_features: _Optional[_Iterable[_Union[_livekit_models_pb2.AudioTrackFeature, str]]] = ...) -> None: ...
...
class JoinResponse(_message.Message):
    ...
    other_participants: _containers.RepeatedCompositeFieldContainer[_livekit_models_pb2.ParticipantInfo]
    server_version: str
    ...
    sif_trailer: bytes
    enabled_publish_codecs: _containers.RepeatedCompositeFieldContainer[_livekit_models_pb2.Codec]
    fast_publish: bool
    def __init__(self, room: _Optional[_Union[_livekit_models_pb2.Room, _Mapping]] = ..., participant: _Optional[_Union[_livekit_models_pb2.ParticipantInfo, _Mapping]] = ..., other_participants: _Optional[_Iterable[_Union[_livekit_models_pb2.ParticipantInfo, _Mapping]]] = ..., server_version: _Optional[str] = ..., ice_servers: _Optional[_Iterable[_Union[ICEServer, _Mapping]]] = ..., subscriber_primary: _Optional[bool] = ..., alternative_url: _Optional[str] = ..., client_configuration: _Optional[_Union[_livekit_models_pb2.ClientConfiguration, _Mapping]] = ..., server_region: _Optional[str] = ..., ping_timeout: _Optional[int] = ..., ping_interval: _Optional[int] = ..., server_info: _Optional[_Union[_livekit_models_pb2.ServerInfo, _Mapping]] = ..., sif_trailer: _Optional[bytes] = ..., enabled_publish_codecs: _Optional[_Iterable[_Union[_livekit_models_pb2.Codec, _Mapping]]] = ..., fast_publish: _Optional[bool] = ...) -> None: ...
...
class ReconnectResponse(_message.Message):
    ...
    def __init__(self, ice_servers: _Optional[_Iterable[_Union[ICEServer, _Mapping]]] = ..., client_configuration: _Optional[_Union[_livekit_models_pb2.ClientConfiguration, _Mapping]] = ..., server_info: _Optional[_Union[_livekit_models_pb2.ServerInfo, _Mapping]] = ..., last_message_seq: _Optional[int] = ...) -> None: ...
...
class TrackPublishedResponse(_message.Message):
    ...
    def __init__(self, cid: _Optional[str] = ..., track: _Optional[_Union[_livekit_models_pb2.TrackInfo, _Mapping]] = ...) -> None: ...
...
class ParticipantUpdate(_message.Message):
    ...
    participants: _containers.RepeatedCompositeFieldContainer[_livekit_models_pb2.ParticipantInfo]
    def __init__(self, participants: _Optional[_Iterable[_Union[_livekit_models_pb2.ParticipantInfo, _Mapping]]] = ...) -> None: ...
...
class UpdateSubscription(_message.Message):
    ...
    subscribe: bool
    participant_tracks: _containers.RepeatedCompositeFieldContainer[_livekit_models_pb2.ParticipantTracks]
    def __init__(self, track_sids: _Optional[_Iterable[str]] = ..., subscribe: _Optional[bool] = ..., participant_tracks: _Optional[_Iterable[_Union[_livekit_models_pb2.ParticipantTracks, _Mapping]]] = ...) -> None: ...
...
class UpdateTrackSettings(_message.Message):
    ...
    fps: int
    priority: int
    def __init__(self, track_sids: _Optional[_Iterable[str]] = ..., disabled: _Optional[bool] = ..., quality: _Optional[_Union[_livekit_models_pb2.VideoQuality, str]] = ..., width: _Optional[int] = ..., height: _Optional[int] = ..., fps: _Optional[int] = ..., priority: _Optional[int] = ...) -> None: ...
...
class UpdateLocalAudioTrack(_message.Message):
    ...
    track_sid: str
    features: _containers.RepeatedScalarFieldContainer[_livekit_models_pb2.AudioTrackFeature]
    def __init__(self, track_sid: _Optional[str] = ..., features: _Optional[_Iterable[_Union[_livekit_models_pb2.AudioTrackFeature, str]]] = ...) -> None: ...
...
class LeaveRequest(_message.Message):
    ...
    def __init__(self, can_reconnect: _Optional[bool] = ..., reason: _Optional[_Union[_livekit_models_pb2.DisconnectReason, str]] = ..., action: _Optional[_Union[LeaveRequest.Action, str]] = ..., regions: _Optional[_Union[RegionSettings, _Mapping]] = ...) -> None: ...
...
class UpdateVideoLayers(_message.Message):
    ...
    track_sid: str
    layers: _containers.RepeatedCompositeFieldContainer[_livekit_models_pb2.VideoLayer]
    def __init__(self, track_sid: _Optional[str] = ..., layers: _Optional[_Iterable[_Union[_livekit_models_pb2.VideoLayer, _Mapping]]] = ...) -> None: ...
...
class SpeakersChanged(_message.Message):
    ...
    speakers: _containers.RepeatedCompositeFieldContainer[_livekit_models_pb2.SpeakerInfo]
    def __init__(self, speakers: _Optional[_Iterable[_Union[_livekit_models_pb2.SpeakerInfo, _Mapping]]] = ...) -> None: ...

class RoomUpdate(_message.Message):
    __slots__ = ("room",)
    ROOM_FIELD_NUMBER: _ClassVar[int]
    room: _livekit_models_pb2.Room
    def __init__(self, room: _Optional[_Union[_livekit_models_pb2.Room, _Mapping]] = ...) -> None: ...
...
class ConnectionQualityInfo(_message.Message):
    ...
    score: float
    def __init__(self, participant_sid: _Optional[str] = ..., quality: _Optional[_Union[_livekit_models_pb2.ConnectionQuality, str]] = ..., score: _Optional[float] = ...) -> None: ...
...
class SubscribedQuality(_message.Message):
    ...
    quality: _livekit_models_pb2.VideoQuality
    enabled: bool
    def __init__(self, quality: _Optional[_Union[_livekit_models_pb2.VideoQuality, str]] = ..., enabled: _Optional[bool] = ...) -> None: ...
...
class SubscribedAudioCodecUpdate(_message.Message):
    ...
    track_sid: str
    subscribed_audio_codecs: _containers.RepeatedCompositeFieldContainer[_livekit_models_pb2.SubscribedAudioCodec]
    def __init__(self, track_sid: _Optional[str] = ..., subscribed_audio_codecs: _Optional[_Iterable[_Union[_livekit_models_pb2.SubscribedAudioCodec, _Mapping]]] = ...) -> None: ...
...
class RoomMovedResponse(_message.Message):
    ...
    participant: _livekit_models_pb2.ParticipantInfo
    other_participants: _containers.RepeatedCompositeFieldContainer[_livekit_models_pb2.ParticipantInfo]
    def __init__(self, room: _Optional[_Union[_livekit_models_pb2.Room, _Mapping]] = ..., token: _Optional[str] = ..., participant: _Optional[_Union[_livekit_models_pb2.ParticipantInfo, _Mapping]] = ..., other_participants: _Optional[_Iterable[_Union[_livekit_models_pb2.ParticipantInfo, _Mapping]]] = ...) -> None: ...
...
class SubscriptionResponse(_message.Message):
    ...
    track_sid: str
    err: _livekit_models_pb2.SubscriptionError
    def __init__(self, track_sid: _Optional[str] = ..., err: _Optional[_Union[_livekit_models_pb2.SubscriptionError, str]] = ...) -> None: ...
...
class ConnectionSettings(_message.Message):
    ...
    def __init__(self, auto_subscribe: _Optional[bool] = ..., adaptive_stream: _Optional[bool] = ..., subscriber_allow_pause: _Optional[bool] = ..., disable_ice_lite: _Optional[bool] = ...) -> None: ...
...
class JoinRequest(_message.Message):
    ...
    participant_sid: str
    sync_state: SyncState
    def __init__(self, client_info: _Optional[_Union[_livekit_models_pb2.ClientInfo, _Mapping]] = ..., connection_settings: _Optional[_Union[ConnectionSettings, _Mapping]] = ..., metadata: _Optional[str] = ..., participant_attributes: _Optional[_Mapping[str, str]] = ..., add_track_requests: _Optional[_Iterable[_Union[AddTrackRequest, _Mapping]]] = ..., publisher_offer: _Optional[_Union[SessionDescription, _Mapping]] = ..., reconnect: _Optional[bool] = ..., reconnect_reason: _Optional[_Union[_livekit_models_pb2.ReconnectReason, str]] = ..., participant_sid: _Optional[str] = ..., sync_state: _Optional[_Union[SyncState, _Mapping]] = ...) -> None: ...
