...
class SIPInboundTrunkUpdate(_message.Message):
    ...
    METADATA_FIELD_NUMBER: _ClassVar[int]
    MEDIA_ENCRYPTION_FIELD_NUMBER: _ClassVar[int]
    numbers: _livekit_models_pb2.ListUpdate
    allowed_addresses: _livekit_models_pb2.ListUpdate
    allowed_numbers: _livekit_models_pb2.ListUpdate
    auth_username: str
    auth_password: str
    name: str
    metadata: str
    media_encryption: SIPMediaEncryption
    def __init__(self, numbers: _Optional[_Union[_livekit_models_pb2.ListUpdate, _Mapping]] = ..., allowed_addresses: _Optional[_Union[_livekit_models_pb2.ListUpdate, _Mapping]] = ..., allowed_numbers: _Optional[_Union[_livekit_models_pb2.ListUpdate, _Mapping]] = ..., auth_username: _Optional[str] = ..., auth_password: _Optional[str] = ..., name: _Optional[str] = ..., metadata: _Optional[str] = ..., media_encryption: _Optional[_Union[SIPMediaEncryption, str]] = ...) -> None: ...
...
class ListSIPTrunkRequest(_message.Message):
    ...
    page: _livekit_models_pb2.Pagination
    def __init__(self, page: _Optional[_Union[_livekit_models_pb2.Pagination, _Mapping]] = ...) -> None: ...
...
class ListSIPInboundTrunkRequest(_message.Message):
    ...
    numbers: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, page: _Optional[_Union[_livekit_models_pb2.Pagination, _Mapping]] = ..., trunk_ids: _Optional[_Iterable[str]] = ..., numbers: _Optional[_Iterable[str]] = ...) -> None: ...
...
class SIPDispatchRuleUpdate(_message.Message):
    ...
    ATTRIBUTES_FIELD_NUMBER: _ClassVar[int]
    MEDIA_ENCRYPTION_FIELD_NUMBER: _ClassVar[int]
    trunk_ids: _livekit_models_pb2.ListUpdate
    rule: SIPDispatchRule
    name: str
    metadata: str
    attributes: _containers.ScalarMap[str, str]
    media_encryption: SIPMediaEncryption
    def __init__(self, trunk_ids: _Optional[_Union[_livekit_models_pb2.ListUpdate, _Mapping]] = ..., rule: _Optional[_Union[SIPDispatchRule, _Mapping]] = ..., name: _Optional[str] = ..., metadata: _Optional[str] = ..., attributes: _Optional[_Mapping[str, str]] = ..., media_encryption: _Optional[_Union[SIPMediaEncryption, str]] = ...) -> None: ...
...
class ListSIPDispatchRuleRequest(_message.Message):
    ...
    trunk_ids: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, page: _Optional[_Union[_livekit_models_pb2.Pagination, _Mapping]] = ..., dispatch_rule_ids: _Optional[_Iterable[str]] = ..., trunk_ids: _Optional[_Iterable[str]] = ...) -> None: ...
...
class SIPCallInfo(_message.Message):
    ...
    started_at_ns: int
    ended_at_ns: int
    disconnect_reason: _livekit_models_pb2.DisconnectReason
    error: str
