...
class TrackEgressRequest(_message.Message):
    ...
    websocket_url: str
    webhooks: _containers.RepeatedCompositeFieldContainer[_livekit_models_pb2.WebhookConfig]
    def __init__(self, room_name: _Optional[str] = ..., track_id: _Optional[str] = ..., file: _Optional[_Union[DirectFileOutput, _Mapping]] = ..., websocket_url: _Optional[str] = ..., webhooks: _Optional[_Iterable[_Union[_livekit_models_pb2.WebhookConfig, _Mapping]]] = ...) -> None: ...
...
class ImageOutput(_message.Message):
    ...
    image_codec: _livekit_models_pb2.ImageCodec
    disable_manifest: bool
    s3: S3Upload
    gcp: GCPUpload
    azure: AzureBlobUpload
    aliOSS: AliOSSUpload
    def __init__(self, capture_interval: _Optional[int] = ..., width: _Optional[int] = ..., height: _Optional[int] = ..., filename_prefix: _Optional[str] = ..., filename_suffix: _Optional[_Union[ImageFileSuffix, str]] = ..., image_codec: _Optional[_Union[_livekit_models_pb2.ImageCodec, str]] = ..., disable_manifest: _Optional[bool] = ..., s3: _Optional[_Union[S3Upload, _Mapping]] = ..., gcp: _Optional[_Union[GCPUpload, _Mapping]] = ..., azure: _Optional[_Union[AzureBlobUpload, _Mapping]] = ..., aliOSS: _Optional[_Union[AliOSSUpload, _Mapping]] = ...) -> None: ...
...
class EncodingOptions(_message.Message):
    ...
    def __init__(self, width: _Optional[int] = ..., height: _Optional[int] = ..., depth: _Optional[int] = ..., framerate: _Optional[int] = ..., audio_codec: _Optional[_Union[_livekit_models_pb2.AudioCodec, str]] = ..., audio_bitrate: _Optional[int] = ..., audio_quality: _Optional[int] = ..., audio_frequency: _Optional[int] = ..., video_codec: _Optional[_Union[_livekit_models_pb2.VideoCodec, str]] = ..., video_bitrate: _Optional[int] = ..., video_quality: _Optional[int] = ..., key_frame_interval: _Optional[float] = ...) -> None: ...
