...
class Job(_message.Message):
    ...
    def __init__(self, id: _Optional[str] = ..., dispatch_id: _Optional[str] = ..., type: _Optional[_Union[JobType, str]] = ..., room: _Optional[_Union[_livekit_models_pb2.Room, _Mapping]] = ..., participant: _Optional[_Union[_livekit_models_pb2.ParticipantInfo, _Mapping]] = ..., namespace: _Optional[str] = ..., metadata: _Optional[str] = ..., agent_name: _Optional[str] = ..., state: _Optional[_Union[JobState, _Mapping]] = ..., enable_recording: _Optional[bool] = ...) -> None: ...
...
class SimulateJobRequest(_message.Message):
    ...
    room: _livekit_models_pb2.Room
    participant: _livekit_models_pb2.ParticipantInfo
    def __init__(self, type: _Optional[_Union[JobType, str]] = ..., room: _Optional[_Union[_livekit_models_pb2.Room, _Mapping]] = ..., participant: _Optional[_Union[_livekit_models_pb2.ParticipantInfo, _Mapping]] = ...) -> None: ...
...
class RegisterWorkerRequest(_message.Message):
    ...
    ping_interval: int
    namespace: str
    allowed_permissions: _livekit_models_pb2.ParticipantPermission
    def __init__(self, type: _Optional[_Union[JobType, str]] = ..., agent_name: _Optional[str] = ..., version: _Optional[str] = ..., ping_interval: _Optional[int] = ..., namespace: _Optional[str] = ..., allowed_permissions: _Optional[_Union[_livekit_models_pb2.ParticipantPermission, _Mapping]] = ...) -> None: ...
...
class RegisterWorkerResponse(_message.Message):
    ...
    def __init__(self, worker_id: _Optional[str] = ..., server_info: _Optional[_Union[_livekit_models_pb2.ServerInfo, _Mapping]] = ...) -> None: ...
