...
class RoomEgress(_message.Message):
    ...
    participant: _livekit_egress_pb2.AutoParticipantEgress
    tracks: _livekit_egress_pb2.AutoTrackEgress
    def __init__(self, room: _Optional[_Union[_livekit_egress_pb2.RoomCompositeEgressRequest, _Mapping]] = ..., participant: _Optional[_Union[_livekit_egress_pb2.AutoParticipantEgress, _Mapping]] = ..., tracks: _Optional[_Union[_livekit_egress_pb2.AutoTrackEgress, _Mapping]] = ...) -> None: ...

class RoomAgent(_message.Message):
    __slots__ = ("dispatches",)
    DISPATCHES_FIELD_NUMBER: _ClassVar[int]
    dispatches: _containers.RepeatedCompositeFieldContainer[_livekit_agent_dispatch_pb2.RoomAgentDispatch]
    def __init__(self, dispatches: _Optional[_Iterable[_Union[_livekit_agent_dispatch_pb2.RoomAgentDispatch, _Mapping]]] = ...) -> None: ...
...
class ListRoomsResponse(_message.Message):
    ...
    def __init__(self, rooms: _Optional[_Iterable[_Union[_livekit_models_pb2.Room, _Mapping]]] = ...) -> None: ...
...
class MuteRoomTrackResponse(_message.Message):
    ...
    def __init__(self, track: _Optional[_Union[_livekit_models_pb2.TrackInfo, _Mapping]] = ...) -> None: ...
...
class UpdateParticipantRequest(_message.Message):
    ...
    def __init__(self, room: _Optional[str] = ..., identity: _Optional[str] = ..., metadata: _Optional[str] = ..., permission: _Optional[_Union[_livekit_models_pb2.ParticipantPermission, _Mapping]] = ..., name: _Optional[str] = ..., attributes: _Optional[_Mapping[str, str]] = ...) -> None: ...
...
class UpdateSubscriptionsRequest(_message.Message):
    ...
    def __init__(self, room: _Optional[str] = ..., identity: _Optional[str] = ..., track_sids: _Optional[_Iterable[str]] = ..., subscribe: _Optional[bool] = ..., participant_tracks: _Optional[_Iterable[_Union[_livekit_models_pb2.ParticipantTracks, _Mapping]]] = ...) -> None: ...
...
class SendDataRequest(_message.Message):
    ...
    topic: str
    nonce: bytes
    def __init__(self, room: _Optional[str] = ..., data: _Optional[bytes] = ..., kind: _Optional[_Union[_livekit_models_pb2.DataPacket.Kind, str]] = ..., destination_sids: _Optional[_Iterable[str]] = ..., destination_identities: _Optional[_Iterable[str]] = ..., topic: _Optional[str] = ..., nonce: _Optional[bytes] = ...) -> None: ...
