import livekit_agent_pb2 as _livekit_agent_pb2
...
class AgentDispatchState(_message.Message):
    ...
    jobs: _containers.RepeatedCompositeFieldContainer[_livekit_agent_pb2.Job]
    created_at: int
    deleted_at: int
    def __init__(self, jobs: _Optional[_Iterable[_Union[_livekit_agent_pb2.Job, _Mapping]]] = ..., created_at: _Optional[int] = ..., deleted_at: _Optional[int] = ...) -> None: ...
