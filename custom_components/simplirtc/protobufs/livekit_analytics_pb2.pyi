...
import livekit_sip_pb2 as _livekit_sip_pb2
...
class AnalyticsClientMeta(_message.Message):
    ...
    country: str
    isp_asn: int
    def __init__(self, region: _Optional[str] = ..., node: _Optional[str] = ..., client_addr: _Optional[str] = ..., client_connect_time: _Optional[int] = ..., connection_type: _Optional[str] = ..., reconnect_reason: _Optional[_Union[_livekit_models_pb2.ReconnectReason, str]] = ..., geo_hash: _Optional[str] = ..., country: _Optional[str] = ..., isp_asn: _Optional[int] = ...) -> None: ...
...
class AnalyticsEvent(_message.Message):
    ...
    node_id: str
    sip_call_id: str
    sip_call: _livekit_sip_pb2.SIPCallInfo
    sip_trunk_id: str
    sip_inbound_trunk: _livekit_sip_pb2.SIPInboundTrunkInfo
    sip_outbound_trunk: _livekit_sip_pb2.SIPOutboundTrunkInfo
    sip_dispatch_rule_id: str
    sip_dispatch_rule: _livekit_sip_pb2.SIPDispatchRuleInfo
    sip_transfer: _livekit_sip_pb2.SIPTransferInfo
    report: ReportInfo
    api_call: APICallInfo
    webhook: WebhookInfo
    def __init__(self, id: _Optional[str] = ..., type: _Optional[_Union[AnalyticsEventType, str]] = ..., timestamp: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., room_id: _Optional[str] = ..., room: _Optional[_Union[_livekit_models_pb2.Room, _Mapping]] = ..., participant_id: _Optional[str] = ..., participant: _Optional[_Union[_livekit_models_pb2.ParticipantInfo, _Mapping]] = ..., track_id: _Optional[str] = ..., track: _Optional[_Union[_livekit_models_pb2.TrackInfo, _Mapping]] = ..., analytics_key: _Optional[str] = ..., client_info: _Optional[_Union[_livekit_models_pb2.ClientInfo, _Mapping]] = ..., client_meta: _Optional[_Union[AnalyticsClientMeta, _Mapping]] = ..., egress_id: _Optional[str] = ..., ingress_id: _Optional[str] = ..., max_subscribed_video_quality: _Optional[_Union[_livekit_models_pb2.VideoQuality, str]] = ..., publisher: _Optional[_Union[_livekit_models_pb2.ParticipantInfo, _Mapping]] = ..., mime: _Optional[str] = ..., egress: _Optional[_Union[_livekit_egress_pb2.EgressInfo, _Mapping]] = ..., ingress: _Optional[_Union[_livekit_ingress_pb2.IngressInfo, _Mapping]] = ..., error: _Optional[str] = ..., rtp_stats: _Optional[_Union[_livekit_models_pb2.RTPStats, _Mapping]] = ..., video_layer: _Optional[int] = ..., node_id: _Optional[str] = ..., sip_call_id: _Optional[str] = ..., sip_call: _Optional[_Union[_livekit_sip_pb2.SIPCallInfo, _Mapping]] = ..., sip_trunk_id: _Optional[str] = ..., sip_inbound_trunk: _Optional[_Union[_livekit_sip_pb2.SIPInboundTrunkInfo, _Mapping]] = ..., sip_outbound_trunk: _Optional[_Union[_livekit_sip_pb2.SIPOutboundTrunkInfo, _Mapping]] = ..., sip_dispatch_rule_id: _Optional[str] = ..., sip_dispatch_rule: _Optional[_Union[_livekit_sip_pb2.SIPDispatchRuleInfo, _Mapping]] = ..., sip_transfer: _Optional[_Union[_livekit_sip_pb2.SIPTransferInfo, _Mapping]] = ..., report: _Optional[_Union[ReportInfo, _Mapping]] = ..., api_call: _Optional[_Union[APICallInfo, _Mapping]] = ..., webhook: _Optional[_Union[WebhookInfo, _Mapping]] = ...) -> None: ...
...
class AnalyticsRoomParticipant(_message.Message):
    ...
    identity: str
    name: str
    state: _livekit_models_pb2.ParticipantInfo.State
    joined_at: _timestamp_pb2.Timestamp
    def __init__(self, id: _Optional[str] = ..., identity: _Optional[str] = ..., name: _Optional[str] = ..., state: _Optional[_Union[_livekit_models_pb2.ParticipantInfo.State, str]] = ..., joined_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class APICallRequest(_message.Message):
    ...
    create_room_request: _livekit_room_pb2.CreateRoomRequest
    list_rooms_request: _livekit_room_pb2.ListRoomsRequest
    delete_room_request: _livekit_room_pb2.DeleteRoomRequest
    list_participants_request: _livekit_room_pb2.ListParticipantsRequest
    room_participant_identity: _livekit_room_pb2.RoomParticipantIdentity
    mute_room_track_request: _livekit_room_pb2.MuteRoomTrackRequest
    update_participant_request: _livekit_room_pb2.UpdateParticipantRequest
    update_subscriptions_request: _livekit_room_pb2.UpdateSubscriptionsRequest
    send_data_request: _livekit_room_pb2.SendDataRequest
    update_room_metadata_request: _livekit_room_pb2.UpdateRoomMetadataRequest
    def __init__(self, create_room_request: _Optional[_Union[_livekit_room_pb2.CreateRoomRequest, _Mapping]] = ..., list_rooms_request: _Optional[_Union[_livekit_room_pb2.ListRoomsRequest, _Mapping]] = ..., delete_room_request: _Optional[_Union[_livekit_room_pb2.DeleteRoomRequest, _Mapping]] = ..., list_participants_request: _Optional[_Union[_livekit_room_pb2.ListParticipantsRequest, _Mapping]] = ..., room_participant_identity: _Optional[_Union[_livekit_room_pb2.RoomParticipantIdentity, _Mapping]] = ..., mute_room_track_request: _Optional[_Union[_livekit_room_pb2.MuteRoomTrackRequest, _Mapping]] = ..., update_participant_request: _Optional[_Union[_livekit_room_pb2.UpdateParticipantRequest, _Mapping]] = ..., update_subscriptions_request: _Optional[_Union[_livekit_room_pb2.UpdateSubscriptionsRequest, _Mapping]] = ..., send_data_request: _Optional[_Union[_livekit_room_pb2.SendDataRequest, _Mapping]] = ..., update_room_metadata_request: _Optional[_Union[_livekit_room_pb2.UpdateRoomMetadataRequest, _Mapping]] = ...) -> None: ...
