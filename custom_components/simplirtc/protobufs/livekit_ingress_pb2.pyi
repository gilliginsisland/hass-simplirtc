...
class IngressAudioOptions(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., source: _Optional[_Union[_livekit_models_pb2.TrackSource, str]] = ..., preset: _Optional[_Union[IngressAudioEncodingPreset, str]] = ..., options: _Optional[_Union[IngressAudioEncodingOptions, _Mapping]] = ...) -> None: ...
...
class IngressVideoOptions(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., source: _Optional[_Union[_livekit_models_pb2.TrackSource, str]] = ..., preset: _Optional[_Union[IngressVideoEncodingPreset, str]] = ..., options: _Optional[_Union[IngressVideoEncodingOptions, _Mapping]] = ...) -> None: ...
...
class IngressAudioEncodingOptions(_message.Message):
    ...
    disable_dtx: bool
    channels: int
    def __init__(self, audio_codec: _Optional[_Union[_livekit_models_pb2.AudioCodec, str]] = ..., bitrate: _Optional[int] = ..., disable_dtx: _Optional[bool] = ..., channels: _Optional[int] = ...) -> None: ...
...
class IngressVideoEncodingOptions(_message.Message):
    ...
    def __init__(self, video_codec: _Optional[_Union[_livekit_models_pb2.VideoCodec, str]] = ..., frame_rate: _Optional[float] = ..., layers: _Optional[_Iterable[_Union[_livekit_models_pb2.VideoLayer, _Mapping]]] = ...) -> None: ...
