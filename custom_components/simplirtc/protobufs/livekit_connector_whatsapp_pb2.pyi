...
class ConnectWhatsAppCallRequest(_message.Message):
    ...
    whatsapp_call_id: str
    sdp: _livekit_rtc_pb2.SessionDescription
    def __init__(self, whatsapp_call_id: _Optional[str] = ..., sdp: _Optional[_Union[_livekit_rtc_pb2.SessionDescription, _Mapping]] = ...) -> None: ...
